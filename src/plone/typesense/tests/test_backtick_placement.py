...
class TestBacktickPlacement(unittest.TestCase):
    ...
    def test_dict_query_single_value(self):
        ...
        result = self.index.get_typesense_filter('portal_type', {'query': 'Document', 'operator': 'or'})
        self.assertEqual(result, 'portal_type:=`Document`')
    ...
    def test_dict_query_list(self):
        ...
        result = self.index.get_typesense_filter(
            'portal_type',
    ...
    def test_real_world_example(self):
        ...
        result = self.index.get_typesense_filter('portal_type', portal_types)
